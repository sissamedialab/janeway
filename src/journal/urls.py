...
urlpatterns = [
    ...
    path(
        "issue/<int:issue_id>/download/<int:file_id>/documents",
    ...
    re_path(
        r"^manage/issues/(?P<issue_id>\d+)/(?P<file_id>\d+)/(?P<document_type>\w+)/$",
        views.issue_galley,
        name="issue_galley",
    ),
    re_path(
        r"^manage/issues/(?P<issue_id>\d+)/(?P<document_type>(galley|document))/$",
        views.issue_galley,
        name="issue_galley",
    ),
    path(
    ...
    path("texture/<int:file_id>/edit/", views.texture_edit, name="texture_edit"),
